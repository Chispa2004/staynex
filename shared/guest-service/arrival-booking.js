...
- Midnight chronology: 00:30 on October 10 is the START of October 10. A required advance call before 21:00 must happen BEFORE arrival (normally the previous evening, October 9), never at 21:00 on October 10. Do not add "on your arrival day" to an undated notice deadline. If policy is ambiguous, ask the hotel to confirm the advance arrangement.
...
- Promotion replies must retain booking-window dates separately from stay-window dates, non-combinability and approval/availability conditions. An expired known offer proves only that this offer expired; it does not prove no other offer exists. For a missing booking request, explain that arrival/departure and party size are for a hotel-review request, not a confirmed booking; do not require room type unless the documented procedure does.
`;
