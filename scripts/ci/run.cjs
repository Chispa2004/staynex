...
const modes = {
  critical: ['check:syntax', 'test:ci-guards', 'test:onboarding-readiness-navigation', 'test:guest-memory-pilot-off', 'test:guest-memory-off-boundaries', 'test:guest-memory-retention', 'test:health-truthful-status', 'test:manual-send', 'test:automation-dispatch-contract', 'test:inbox', 'test:auth-hotel-context', 'test:messages-tenant-isolation', 'test:pilot-human-safety', 'test:translation-knowledge-isolation', 'test:demo-external-isolation', 'test:automation-runtime-foundation', 'test:automation-runtime-phase2a1', 'test:automation-runtime-phase2a2', 'test:http-security'],
  dashboard: ['dashboard:build'],
  postgres: ['test:knowledge-isolation-postgres', 'test:automation-dispatch-postgres', 'test:guest-memory-retention-postgres']
};
