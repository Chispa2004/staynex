...
assert.match(globalStylesSource, /--staynex-panel-light: #ffffff/, 'Content panels should remain clean and white');
assert.match(globalStylesSource, /--staynex-sidebar-light/, 'Sidebar should have a differentiated shared light token');
