...
export function prepareCheckinAiLoad({backup,generations}) {
  ...
  for(const k of syntheticKnowledgeAdditions)added.hotel_knowledge.push({id:demoMessageStageId(h,'ai-knowledge',k.key),hotel_id:h,key:k.key,value:k.value,is_active:true});
