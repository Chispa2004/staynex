...
const modules = [
  ...
  },
  {
    ...
    example: 'Admin crea una recepcionista para Costa Azul y confirma que no ve PMS ni usuarios.',
  ...
  },
  {
    ...
    use: 'Recepcion confirma disponibilidad, contacta partner y cambia estado.',
    actions: ['Revisa pendientes.', 'Asigna responsable.', 'Confirma o rechaza.', 'Anade notas internas.'],
    example: 'Huesped pide Agafay Desert Dinner; se crea solicitud pending para Luxotour.',
  ...
  },
  {
    ...
    roles: ['admin', 'receptionist'],
    title: 'Experiences',
    summary: 'Actividades, excursiones y experiencias que la IA puede recomendar.',
    what: 'Catalogo propio del hotel con precio, partner, tags y comision.',
    use: 'Hace que la IA recomiende opciones reales del hotel, no contenido generico.',
    actions: ['Crea experiencias claras.', 'Activa solo las disponibles.', 'Anade tags family, romantic, VIP o indoor.', 'Incluye partner y precio si existe.'],
    example: 'Recepcion crea "Excursion en barco" y la IA la recomienda cuando preguntan por planes.',
  ...
  },
  {
    ...
    example: 'Recepcion anade una cala tranquila para parejas y la IA la menciona en contexto romantico.',
